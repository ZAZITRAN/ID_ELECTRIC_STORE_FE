      ...
      <div className="setup-mar">
        <div className="blog-page__body">
          ...
          <div className="blog-detail">
            <div className="blog-detail__texttop">
                        ...
                        <div className="newarrival__in4sp">
                          <div className="newarrival__in4sp-left1">
                            ...
                            <div className="cc__admin">
                              by <div className="cc__admin-name">Admin</div>, 12
                              Jan 2021
                            </div>
                          </div>
                        </div>
            ...
            <div className="comment-troxuong">
              <div className="commentdao">
                <div className="commentdao__texttop">Comments</div>

                <div className="commentdao__list">
                  <div className="comment-from-user">
                    <div className="comment-from-user__top">
                      <div className="comment-from-userll">
                        <img src="" alt="" />
                      </div>

                      <div className="comment-nameuser">
                        <p>Samantha</p>
                        <span>1 Month Ago</span>
                      </div>
                    </div>

                    <div className="comment-from-user__content">
              ...
              <form id="commentdao__leave">
                <div className="comment-leave-top">Leave a Comment</div>
                
                <div className="comment-leave-top__nametextarea">Comment *</div>       
                <textarea name="comment" id="" cols="100" rows="5"></textarea>
                <div className="comment-leave__email">
                  <div>
                    <span>Name *</span>
                ...
                <button type="submit" className="comment-leave-btn">Submit</button>
